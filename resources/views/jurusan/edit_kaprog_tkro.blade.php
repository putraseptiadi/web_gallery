...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin2/edit_kaprog_tkro.css') }}">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Edit Kaprog TKRO</h1>
            ...
            <div class="container my-5">
                <form action="{{ route('tkro_program.update', $KetuaTkro->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="nama" name="nama" class="form-control" value="{{ old('nama', $KetuaTkro->nama) }}" required>
                    </div>

                    <!-- Input Bidang Keahlian -->
                    <div class="form-group mb-3">
                        <label for="bidang_keahlian">Bidang Keahlian</label>
                        <input type="text" id="bidang_keahlian" name="bidang_keahlian" class="form-control" value="{{ old('bidang_keahlian', $KetuaTkro->bidang_keahlian) }}" required>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        @if ($KetuaTkro->foto)
                        <p>foto saat ini:</p>
                        <img src="{{ Storage::url($KetuaTkro->foto) }}" alt="Foto Ketua Program" width="100" class="mt-2">
                        @endif
                    </div>
