...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin2/edit_kaprog_tjkt.css') }}">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Edit Kaprog TJKT</h1>
            ...
            <div class="container my-5">
                <form action="{{ route('tjkt_program.update', $KetuaTjkt->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="nama" name="nama" class="form-control" value="{{ old('nama', $KetuaTjkt->nama) }}" required>
                    </div>

                    <!-- Input Bidang Keahlian -->
                    <div class="form-group mb-3">
                        <label for="bidang_keahlian">Bidang Keahlian</label>
                        <input type="text" id="bidang_keahlian" name="bidang_keahlian" class="form-control" value="{{ old('bidang_keahlian', $KetuaTjkt->bidang_keahlian) }}" required>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        @if ($KetuaTjkt->foto)
                        <p>foto saat ini:</p>
                        <img src="{{ Storage::url($KetuaTjkt->foto) }}" alt="Foto Ketua Program" width="100" class="mt-2">
                        @endif
                    </div>
