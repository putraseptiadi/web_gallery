...
<head>
    ...
    <title>UJIKOM</title>
    <link rel="stylesheet" href="{{ asset('css/jurusan/tjkt.css') }}">
    ...
    <section class="program-info container my-5">
        <div class="row">
            ...
            <div class="col-md-4 text-center d-flex flex-column align-items-center">
                <img src="{{ asset('path/images/TJKT.png') }}" alt="Logo SMK NEGERI 4 BOGOR" class="img-fluid mb-4" style="max-width: 100%; height: auto;">
            </div>
            ...
            <div class="col-md-8">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-9">
                        ...
                        <p><strong>Nama:</strong> {{ $KetuaTjkt->nama }}<br>
                            <strong>Bidang Keahlian:</strong> {{ $KetuaTjkt->bidang_keahlian }}
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="program-info container my-5">
        <div class="row">
            <div class="col-md-6">
                ...
                <ul>
                    @foreach($PrestasiTjkt as $key => $prestasi)
                    <li>
            ...
            <div class="col-md-6">
                ...
                <ul>
                    @foreach($ProfesiTjkt as $key => $profesi)
                    <li>
                        {{ $profesi->judul }}
                    </li>
                    @endforeach
