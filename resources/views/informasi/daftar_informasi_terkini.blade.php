...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin2/daftar_informasi_terkini.css') }}">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                <div class="informasi-item">
                    ...
                    <div class="action-buttons">
                        <a href="{{ route('informasi_admin.edit', $informasi->id) }}" class="btn btn-warning">Edit</a>
                        <form action="{{ route('informasi_admin.destroy', $informasi->id) }}" method="POST" style="display: inline-block;">
                            @csrf
                            @method('DELETE')
