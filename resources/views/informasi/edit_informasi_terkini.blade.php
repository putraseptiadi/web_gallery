    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Edit Informasi Terkini</h1>
            ...
            <!-- Tombol Kembali -->
            <a href="/admin/daftar_informasi_terkini" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
            ...
            <form action="{{ route('informasi_admin.update', $informasi->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="form-group">
                    <label for="instagram_url">URL Instagram</label>
                    <input type="url" name="instagram_url" id="instagram_url" value="{{ $informasi->instagram_url }}" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for="description">Deskripsi</label>
                    <textarea name="description" id="description" class="form-control" required>{{ $informasi->description }}</textarea>
                </div>
