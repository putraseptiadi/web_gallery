    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Edit Ekstrakulikuler</h1>
            ...
            <div class="container mx-auto mt-8">
                <form action="{{ route('eskul_admin.update', $eskul->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group mb-4">
                        ...
                        <textarea name="description" id="description" class="form-control" required>{{ $eskul->description }}</textarea>
                    </div>

                    <div class="form-group mb-4">
                        <label for="schedule" class="block font-medium">Jadwal</label>
                        <input type="text" name="schedule" id="schedule" class="form-control" value="{{ $eskul->schedule }}" required>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        @if ($eskul->logo)
                        <p>logo saat ini:</p>
                        <img src="{{ asset('storage/' . $eskul->logo) }}" alt="Logo" class="w-16 h-16 mb-2">
                        @endif
                        <input type="file" name="logo" id="logo" class="form-control">
                    </div>

                    <button type="submit" class="btn btn-primary bg-blue-600 text-white px-4 py-2 rounded-md">Simpan</button>
                </form>
            </div>
