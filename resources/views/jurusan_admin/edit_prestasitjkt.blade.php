...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/edit_prestasi_tjkt.css') }}">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Edit Prestasi TJKT</h1>
            ...
            <!-- Tombol Kembali -->
            <a href="/admin/manage_propres_tjkt" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
            ...
            <section class="program-info container my-5">
                <div class="row">
                    <form action="{{ route('prestasitjkt.update', $PrestasiTjkt->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="judul">Judul Prestasi</label>
                            <input type="text" name="judul" id="judul" class="form-control" value="{{ $PrestasiTjkt->judul }}" required>
                        </div>
                        <div class="form-group">
                            <label for="tahun">Tahun</label>
                            <input type="number" name="tahun" id="tahun" class="form-control" value="{{ $PrestasiTjkt->tahun }}" required>
                        </div>
