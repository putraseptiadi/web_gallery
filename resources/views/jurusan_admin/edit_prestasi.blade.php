...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/edit_prestasi_pplg.css') }}">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Edit Prestasi PPLG</h1>
            ...
            <!-- Tombol Kembali -->
            <a href="/admin/manage_propres_pplg" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
            ...
            <div class="container my-5">
                <form action="{{ route('prestasi.update', $prestasi->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" name="tahun" class="form-control" value="{{ $prestasi->tahun }}" required>
                    </div>
