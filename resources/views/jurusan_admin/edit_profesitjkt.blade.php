...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/edit_profesi_tjkt.css') }}">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Edit Profesi TJKT</h1>
            ...
            <section class="program-info container my-5">
                <div class="row">
                    <form action="{{ route('profesitjkt.update', $ProfesiTjkt->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="judul">Judul Profesi</label>
                            <input type="text" name="judul" id="judul" class="form-control" value="{{ $ProfesiTjkt->judul }}" required>
                        </div>
