...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/edit_prestasi_tkro.css') }}">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Edit Prestasi TKRO</h1>
            ...
            <!-- Tombol Kembali -->
            <a href="/admin/manage_propres_tkro" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
            ...
            <section class="program-info container my-5">
                <div class="row">
                    <form action="{{ route('prestasitkro.update', $PrestasiTkro->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="judul">Judul Prestasi</label>
                            <input type="text" name="judul" id="judul" class="form-control" value="{{ $PrestasiTkro->judul }}" required>
                        </div>
                        <div class="form-group">
                            <label for="tahun">Tahun</label>
                            <input type="number" name="tahun" id="tahun" class="form-control" value="{{ $PrestasiTkro->tahun }}" required>
                        </div>
