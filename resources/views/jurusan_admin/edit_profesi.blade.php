...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/edit_profesi_pplg.css') }}">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Edit Profesi</h1>
            ...
            <div class="container my-5">
                <form action="{{ route('profesi.update', $profesi->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" name="judul" class="form-control" value="{{ $profesi->judul }}" required>
                    </div>
