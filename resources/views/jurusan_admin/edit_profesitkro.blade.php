...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/edit_profesi_tkro.css') }}">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Edit Profesi TKRO</h1>
            ...
            <section class="program-info container my-5">
                <div class="row">
                    <form action="{{ route('profesitkro.update', $ProfesiTkro->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="judul">Judul Profesi</label>
                            <input type="text" name="judul" id="judul" class="form-control" value="{{ $ProfesiTkro->judul }}" required>
                        </div>
