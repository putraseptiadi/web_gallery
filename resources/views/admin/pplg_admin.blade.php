...
<head>
    ...
    <title>Manage PPLG</title>
    <link rel="stylesheet" href="{{ asset('css/admin/manage_pplg.css') }}">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Manage PPLG</h1>
            ...
            <a href="{{ route('jurusan_admin.manage_propres_pplg') }}" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
                Lihat Manage propres pplg
            ...
            <div class="container">
                <form action="{{ route('ketua_program.store') }}" method="POST" enctype="multipart/form-data" class="form-ketua-program">
                    @csrf
                    ...
                    <div class="ketua-program-row">
                        ...
                        <div class="ketua-program-content">
                            <div class="ketua-program-body">
                                <h5 class="ketua-program-title"><strong>Nama:</strong> {{ $ketuaProgram->nama }}</h5>
                                <p class="ketua-program-title"><strong>Bidang Keahlian:</strong> {{ $ketuaProgram->bidang_keahlian }}</p>
                                <div class="ketua-program-buttons">
                                    <a href="{{ route('ketua_program.edit', $ketuaProgram->id) }}" class="btn btn-edit">Edit</a>
                                    <form action="{{ route('ketua_program.destroy', $ketuaProgram->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
