...
<body>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <!-- Tombol Kembali -->
            <a href="/admin/daftar_gallery" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
            ...
            <form action="{{ route('galery_admin.update', $gallery->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <p>Foto saat ini:</p>
                    <img src="{{ asset('storage/' . $gallery->photo_path) }}" alt="Current photo" width="100">
                </div>
