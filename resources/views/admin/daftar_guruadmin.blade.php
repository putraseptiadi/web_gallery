...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/Daftar_guru.css') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-12 mb-4">
                        <div class="card text-center">
                            <img src="{{ asset('storage/uploads/' . $guru->profile_picture) }}" class="card-img-top" alt="{{ $guru->name }}" style="width: 100px; height: 100px; margin: 0 auto; border-radius: 50%; border: 2px solid #3b82f6;">
                            <div class="card-body">
                                <p class="card-text">{{ $guru->name }}</p>
                            </div>
                            <div class="card-footer d-flex justify-content-between"> <!-- Menambahkan d-flex untuk menyelaraskan tombol -->
                                <!-- Tombol Edit -->
                                <a href="{{ route('admin.edit_guru', $guru->id) }}" class="btn btn-primary w-48">Edit</a> <!-- Menyesuaikan lebar tombol -->
                                <!-- Tombol Hapus dengan JavaScript konfirmasi -->
                                <form action="{{ route('admin.destroy', $guru->id) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
