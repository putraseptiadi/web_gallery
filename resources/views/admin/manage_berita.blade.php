...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/sarpras.css') }}">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Manage Berita</h1>
            ...
            <div class="container">
                ...
                <form action="{{ route('berita.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="judul" id="judul" class="form-input mt-1 block w-full" required>
                    </div>
                    <div class="mb-4">
                        <label for="konten" class="block">Konten</label>
                        <textarea name="konten" id="konten" class="form-input mt-1 block w-full" rows="5" required></textarea>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="url" name="link" id="link" class="form-input mt-1 block w-full">
                    </div>
