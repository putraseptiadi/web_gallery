...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/gallery_admin.css') }}">
...
<body>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <a href="{{ route('admin2.daftar_gallery') }}" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
            ...
            <form action="{{ route('galery_admin.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
