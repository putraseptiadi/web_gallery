...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/guru_admin.css') }}">
...
<body>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <a href="{{ route('admin.daftar_guruadmin') }}" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
                Lihat Daftar Guru
