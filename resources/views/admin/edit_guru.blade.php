...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/Edit_guru.css') }}">
...
<body>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Edit Guru</h1>
            ...
            <!-- Tombol Kembali -->
            <a href="/admin/daftar_guruadmin" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
    ...
    <script>
        function confirmDelete(id) {
            if (confirm('Apakah kamu yakin ingin menghapus admin ini?')) {
                // Kirim permintaan hapus dengan fetch API
                fetch(`/admin/${id}`, {
                    method: 'DELETE',
                    headers: {
