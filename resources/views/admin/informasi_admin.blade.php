...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin2/informasi_terkini.css') }}">
...
<body>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <a href="{{ route('informasi.daftar_informasi_terkini') }}" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
            ...
            <form action="{{ route('informasi_store') }}" method="POST">
                @csrf
                <div class="mb-4">
