...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin2/manage_agenda.css') }}">
...
<body>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <a href="{{ route('admin2.daftar_agenda') }}" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
                Lihat Daftar Agenda
