...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/daftar_gallery.css') }}">
...
<body>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <!-- Tombol Kembali -->
            <a href="{{ route('galery_admin') }}" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
            ...
            <div class="row">
                ...
                <div class="card col-md-3 col-sm-6">
                    <!-- Gambar Foto -->
                    <img src="{{ asset('storage/' . $gallery->photo_path) }}" alt="Foto Galeri" class="card-img-top mx-auto mt-4">

                    <!-- Deskripsi -->
                    <div class="card-body">
                        <p class="text-gray-600 font-medium text-center">{{ $gallery->description }}</p>
                    </div>

                    <div class="card-footer">
                        <a href="{{ route('galery_admin.edit', $gallery->id) }}" class="btn btn-primary">Edit</a>
                        <form action="{{ route('galery_admin.destroy', $gallery->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus foto ini?')">
                            @csrf
                            @method('DELETE')
