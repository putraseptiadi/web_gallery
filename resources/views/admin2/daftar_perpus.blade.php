...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin2/daftar_perpustakaan.css') }}">
...
<body>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <!-- Tombol Kembali -->
            <a href="{{ route('manage_perpus') }}" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
            ...
            <table class="custom-table">
                ...
                <tr>
                    ...
                    <td style="display: flex; align-items: center; gap: 10px;">
                        <a href="{{ route('buku.edit', $buku->id) }}" style="text-decoration: none;">Edit</a>
