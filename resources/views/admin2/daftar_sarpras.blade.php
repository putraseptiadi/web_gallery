...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/daftar_sarpras.css') }}">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Daftar Sarana & Prasarana</h1>
            ...
            <!-- Tombol Kembali -->
            <a href="{{ route('sarpras_admin') }}" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-gray-100 rounded-lg shadow-lg p-6 transition hover:shadow-xl">
                    <h3 class="text-lg font-semibold text-gray-700">{{ $sarpras->name }}</h3>
                    <p class="text-gray-600">{{ $sarpras->description }}</p>
                    <img src="{{ asset('storage/sarpras/' . $sarpras->photo_path) }}"
                        alt="{{ $sarpras->name }}"
                        class="w-full h-40 object-cover rounded-md mt-3">
                    <div class="mt-4 flex space-x-3">
                        <a href="{{ route('sarpras.edit', $sarpras->id) }}"
                            class="btn btn-primary">Edit</a>
                        <form action="{{ route('sarpras.delete', $sarpras->id) }}"
                            method="POST"
