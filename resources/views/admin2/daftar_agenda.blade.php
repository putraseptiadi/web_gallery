...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin2/daftar_agenda.css') }}">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Daftar Agenda</h1>
            ...
            <!-- Tombol Kembali -->
            <a href="{{ route('agenda_admin') }}" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
            ...
            <div class="space-y-4">
                ...
                <div class="card-agenda">
                    ...
                    <p class="text-gray-500">{{ \Carbon\Carbon::parse($item->date)->format('d F Y') }}</p>
                    <p class="text-gray-500">{{ $item->location }}</p>

                    <div class="action-buttons">
                        <!-- Edit Button -->
                        <a href="{{ route('agenda_admin.edit', $item->id) }}">Edit</a>

                        <!-- Delete Button -->
                        <form action="{{ route('agenda_admin.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus agenda ini?')">
                            @csrf
                            @method('DELETE')
