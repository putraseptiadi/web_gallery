...
<body>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <!-- Tombol Kembali -->
            <a href="{{ route('daftar_berita') }}" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
            ...
            <div class="container">
                ...
                <form action="{{ route('berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="judul" id="judul" class="form-input mt-1 block w-full" value="{{ old('judul', $berita->judul) }}" required>
                    </div>

                    <div class="mb-4">
                        <label for="konten" class="block">Konten</label>
                        <textarea name="konten" id="konten" class="form-input mt-1 block w-full" rows="5" required>{{ old('konten', $berita->konten) }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <img src="{{ $berita->foto_url }}" alt="Foto Berita" class="h-32 w-auto mt-2">
                        @endif
                    </div>

                    <div class="mb-4">
                        <label for="link" class="block">Link Berita</label>
                        <input type="url" name="link" id="link" class="form-input mt-1 block w-full" value="{{ old('link', $berita->link) }}">
                    </div>
