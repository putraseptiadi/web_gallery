...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/admin2/daftar_informasi_terkini.css')); ?>">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Daftar Informasi Terkini</h1>
            ...
            <!-- Tombol Kembali -->
            <a href="<?php echo e(route('informasi_admin')); ?>" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                <div class="informasi-item">
                    ...
                    <div class="action-buttons">
                        <a href="<?php echo e(route('informasi_admin.edit', $informasi->id)); ?>" class="btn btn-warning">Edit</a>
                        <form action="<?php echo e(route('informasi_admin.destroy', $informasi->id)); ?>" method="POST" style="display: inline-block;">
                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\SMKN4\bismillah\resources\views/informasi/daftar_informasi_terkini.blade.php ENDPATH**/ ?>