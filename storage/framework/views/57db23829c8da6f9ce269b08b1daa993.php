...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/admin2/informasi_terkini.css')); ?>">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Manage Informasi</h1>
            ...
            <a href="<?php echo e(route('informasi.daftar_informasi_terkini')); ?>" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
                Lihat Daftar Informasi Terkini
            ...
            <form action="<?php echo e(route('informasi_store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="mb-4">
                    <label for="instagram_url" class="block text-gray-700">Instagram URL</label>
                    <input type="url" name="instagram_url" id="instagram_url" class="mt-2 p-2 border border-gray-300 rounded w-full" required>
                </div>

                <div class="mb-4">
                    <label for="description" class="block text-gray-700">Deskripsi</label>
                    <textarea name="description" id="description" class="mt-2 p-2 border border-gray-300 rounded w-full" required></textarea>
                </div>
...
</html><?php /**PATH C:\SMKN4\bismillah\resources\views/admin/informasi_admin.blade.php ENDPATH**/ ?>