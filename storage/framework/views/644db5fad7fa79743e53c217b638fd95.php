...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/admin2/daftar_slideshow.css')); ?>">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Daftar Slideshow</h1>
            ...
            <!-- Tombol Kembali -->
            <a href="<?php echo e(route('manage_home')); ?>" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
                    ...
                    <table class="table carousel-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="<?php echo e(asset('storage/' . $item->image_path)); ?>" alt="Image" class="carousel-image">
                                </td>
                                <td class="carousel-actions">
                                    <a href="<?php echo e(route('carousel.edit', $item->id)); ?>" class="btn btn-warning btn-sm">Edit</a>
                                    <form action="<?php echo e(route('carousel.destroy', $item->id)); ?>" method="POST" style="display:inline;">
                                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\SMKN4\bismillah\resources\views/admin2/daftar_slideshow.blade.php ENDPATH**/ ?>