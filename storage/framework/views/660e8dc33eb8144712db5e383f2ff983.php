...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/admin/edit_gallery.css')); ?>">
...
<body>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <form action="<?php echo e(route('carousel.update', $carouselItem->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>

                <div class="mb-3">
                    <label for="title" class="form-label">Title</label>
                    <input type="text" name="title" id="title" class="form-control" value="<?php echo e($carouselItem->title); ?>" required>
                </div>

                <div class="mb-3">
                    <label for="description" class="form-label">Description</label>
                    <textarea name="description" id="description" class="form-control" required><?php echo e($carouselItem->description); ?></textarea>
                </div>

                <div class="mb-3">
                    <label for="image" class="form-label">Image</label>
                    <input type="file" name="image" id="image" class="form-control">
                    <img src="<?php echo e(asset('storage/' . $carouselItem->image_path)); ?>" alt="Current Image" width="150" class="mt-2">
                </div>
...
</html><?php /**PATH C:\SMKN4\bismillah\resources\views/admin/edit_slideshow.blade.php ENDPATH**/ ?>