...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/admin/gallery_admin.css')); ?>">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Manage Gallery</h1>
            ...
            <a href="<?php echo e(route('admin2.daftar_gallery')); ?>" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
                Lihat Daftar Gallery
            ...
            <form action="<?php echo e(route('galery_admin.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
            ...
            <!-- Toastr untuk menampilkan pesan sukses -->
...
</html><?php /**PATH C:\SMKN4\bismillah\resources\views/admin/galery_admin.blade.php ENDPATH**/ ?>