    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Edit Perpustakaan</h1>
            ...
            <form action="<?php echo e(route('buku.update', $buku->id)); ?>" method="POST" enctype="multipart/form-data">
                ...
                <input type="text" name="judul" value="<?php echo e($buku->judul); ?>" required><br><br>

                <label for="penulis">Penulis:</label>
                <input type="text" name="penulis" value="<?php echo e($buku->penulis); ?>" required><br><br>

                <label for="penerbit">Penerbit:</label>
                <input type="text" name="penerbit" value="<?php echo e($buku->penerbit); ?>" required><br><br>

                <label for="tahun_terbit">Tahun Terbit:</label>
                <input type="number" name="tahun_terbit" value="<?php echo e($buku->tahun_terbit); ?>" required><br><br>
                ...
                <select name="status">
                    <option value="tersedia" <?php echo e($buku->status == 'tersedia' ? 'selected' : ''); ?>>Tersedia</option>
                    <option value="tidak tersedia" <?php echo e($buku->status == 'tidak tersedia' ? 'selected' : ''); ?>>Tidak Tersedia</option>
                </select><br><br>
...
</html><?php /**PATH C:\SMKN4\bismillah\resources\views/berita_program_perpus/edit_buku.blade.php ENDPATH**/ ?>