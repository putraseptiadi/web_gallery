    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-8">
                <h1 class="text-3xl font-bold">Manage Home</h1>
            ...
            <a href="<?php echo e(route('daftar_slideshow')); ?>" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
                Lihat Daftar Slidshow
...
</html><?php /**PATH C:\SMKN4\bismillah\resources\views/admin/manage_home.blade.php ENDPATH**/ ?>