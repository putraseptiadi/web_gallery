...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/admin2/daftar_berita.css')); ?>">
...
<body>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <!-- Tombol Kembali -->
            <a href="<?php echo e(route('manage_berita')); ?>" class="text-blue-600 hover:text-blue-800 flex items-center mb-4">
            ...
            <div class="berita-container">
                <div class="berita-grid berita-grid-cols-1 md:berita-grid-cols-3 gap-6">
                    <?php $__currentLoopData = $beritas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $berita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="berita-border p-4 rounded-lg">
                        <img src="<?php echo e($berita->foto_url); ?>"
                            alt="<?php echo e($berita->judul); ?>"
                            class="berita-img h-55 w-full object-cover rounded-lg mb-2">
                        <h2 class="berita-title text-lg font-semibold"><?php echo e($berita->judul); ?></h2>
                        <p class="berita-text text-gray-600"><?php echo e(Str::limit($berita->konten, 100)); ?></p>
                        <a href="<?php echo e($berita->link); ?>" class="berita-link text-blue-500 hover:underline" target="_blank">Baca Selengkapnya</a>
                        <div class="mt-4">
                            <a href="<?php echo e(route('berita.edit', $berita->id)); ?>" class="berita-btn berita-btn-warning">Edit</a>
                            <form action="<?php echo e(route('berita.destroy', $berita->id)); ?>" method="POST" class="berita-inline">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <button type="submit" class="berita-btn berita-btn-danger">Hapus</button>
                            </form>
                        </div>
                    </div>
...
</html><?php /**PATH C:\SMKN4\bismillah\resources\views/admin2/daftar_berita.blade.php ENDPATH**/ ?>