...
<head>
    ...
    <title>UJIKOM</title>
    <link rel="stylesheet" href="<?php echo e(asset('css/jurusan/tflm.css')); ?>">
    ...
    <section class="program-info container my-5">
        <div class="row">
            ...
            <div class="col-md-4 text-center d-flex flex-column align-items-center">
                <img src="<?php echo e(asset('path/images/TFLM.png')); ?>" alt="Logo SMK NEGERI 4 BOGOR" class="img-fluid mb-4" style="max-width: 100%; height: auto;">
            </div>
            ...
            <div class="col-md-8">
                ...
                <div class="row align-items-center">
                    <?php $__currentLoopData = $KetuaTflm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $KetuaTflm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-3 text-center">
                        <img src="<?php echo e(asset('storage/' . ($KetuaTflm->foto ?? 'path/images/pp_kosong.jpg'))); ?>"
                            alt="Ketua Program" class="img-fluid rounded-circle" style="width: 150px; height: 150px;">
                    </div>
                    <div class="col-md-9">
                        <h3>Ketua Program Keahlian</h3>
                        <p><strong>Nama:</strong> <?php echo e($KetuaTflm->nama); ?><br>
                            <strong>Bidang Keahlian:</strong> <?php echo e($KetuaTflm->bidang_keahlian); ?>
    ...
    <section class="program-info container my-5">
        <div class="row">
            <div class="col-md-6">
                ...
                <ul>
                    <?php $__currentLoopData = $PrestasiTflm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $prestasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
            ...
            <div class="col-md-6">
                ...
                <ul>
                    <?php $__currentLoopData = $ProfesiTflm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $profesi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
...
</html><?php /**PATH C:\SMKN4\bismillah\resources\views/jurusan/tflm.blade.php ENDPATH**/ ?>