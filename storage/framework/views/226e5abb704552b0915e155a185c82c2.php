    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$title, $count, $url]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e($url); ?>" class="block stats-card bg-white shadow rounded-lg p-6 hover:bg-gray-100 transition">
                    <h2 class="text-gray-600 font-semibold stats-card-title"><?php echo e($title); ?></h2>
                    <p class="text-2xl font-bold stats-card-count"><?php echo e($count); ?></p>
                </a>
...
</html><?php /**PATH C:\SMKN4\bismillah\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>