...
<head>
    ...
    <title>Profile</title>
    <link rel="stylesheet" href="<?php echo e(asset('css/admin/profile_admin.css')); ?>">
...
<body>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="profile-container">
                ...
                <div class="profile-info">
                    <div class="profile-item">
                        ...
                        <span class="profile-text"><?php echo e(Auth::user()->email); ?></span>
                    </div>
                    <div class="profile-item">
                        <span class="label">Username:</span>
                        <span class="profile-text"><?php echo e(Auth::user()->name); ?></span>
                    </div>
                </div>
            </div>
            ...
            <form action="<?php echo e(route('profile.upload')); ?>" method="POST" enctype="multipart/form-data" class="mt-6 profile-upload-form">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\SMKN4\bismillah\resources\views/admin/profile_admin.blade.php ENDPATH**/ ?>